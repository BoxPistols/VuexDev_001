  ...
  <div class="grid-container">
    ...
    <nav class="nav">
      <div class="nav_toggle">
        <svg width="100pt" height="100pt" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="#333">
          <g>
            <path d="m63.801 55.5h-44.801c-3 0-5.5-2.5-5.5-5.5s2.5-5.5 5.5-5.5h44.898c3 0 5.5 2.5 5.5 5.5-0.097657 3-2.5 5.5-5.5977 5.5z" />
            <path d="m44.398 86.898h-25.398c-3 0-5.5-2.5-5.5-5.5s2.5-5.5 5.5-5.5h25.398c3 0 5.5 2.5 5.5 5.5 0 3.1016-2.5 5.5-5.5 5.5z" />
            <path d="m81.301 24h-62.301c-3 0-5.5-2.5-5.5-5.5s2.5-5.5 5.5-5.5h62.398c3 0 5.5 2.5 5.5 5.5-0.097657 3-2.5 5.5-5.5977 5.5z" />
          </g>
        </svg>
      </div>
      <div class="org_nav">
    ...
    <article class="article">
      <div class="contents">
        <div class="row">
          <div class="grd">
            <div class="grd_l-12">
              <div class="lay_card d_flex">
                <div class="grd_l-4 md_l-12">
                  <div class="org_card">
                    <div class="mol_card">
                      <div class="mol_card-title">Card</div>
                      <div class="mol_card-content">Lorem ipsum dolor sit amex consenter adipisicing elif. Amt, esse?</div>
                    </div>
                  </div>
                </div>
                <div class="grd_l-4 md_l-12">
              ...
              <div class="org_board">
                <div class="mol_board-pd">
                  <div class="mol_board-content">
                    <h3 class="mol_board-title">board</h3>Lorem ipsum dolor sit amex consenter adipisicing elif. Amt, esse?
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      <small>Copyright &copy; 2019-2020 Asagiri Design All Rights Reserved.</small>
    </footer>
  </div>
</div>
</template>
